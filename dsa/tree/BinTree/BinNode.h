...
// 操作接口
    ...
    // 二叉树先序遍历算法统一入口
    template <typename VST> void travPre(VST& visit, int n = 0) {
        switch (n) {
    ...
    // 二叉树中序遍历算法统一入口
    template <typename VST> void travIn (VST& visit, int n = 0) {
        switch (n) {
    ...
    // 二叉树后序遍历算法统一入口
    template <typename VST> void travPost(VST& visit, int n = 0) {
