...
void testVector(int testSize)
{
    ...
    V.sort(0, V.size(), OperateType::SORT_BUBBLE);
    PRINT(V);
    ...
    V.sort(0, V.size(), OperateType::SORT_SELECT);
    PRINT(V);
    ...
    V.sort(0, V.size(), OperateType::SORT_MERGE);
    PRINT(V);
    ...
    V.sort(0, V.size(), OperateType::SORT_QUICK);
    PRINT(V);
